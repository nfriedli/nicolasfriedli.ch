...
`minify` permet d’optimiser les pages produites par Hugo.
...
Mais à y regarder de plus près, il n’est pas certain que ce classement soit valable.
...
Quels que soient les efforts sur une telle page, tous est cassé par un seul fichier problématique.
...
> Avant même de chercher à optimiser, il vaut la peine de détecter des erreurs manifestes qui annihileront tous les efforts

## Se demander ce qui est nécessaire

Des tests montrent [qusqu’à 45% des fonctionnalités demandées par un utilisateur ne sont jamais utilisées et que jusqu’à 70% peuvent être considérées comme «non essentielles»](https://rweb.greenit.fr/fr/fiches/RWEB_0001-eliminer-les-fonctionnalites-non-essentielles).
...
Mais la constante est que le meilleur résultat à tout prix n’est pas la première préoccupation.
