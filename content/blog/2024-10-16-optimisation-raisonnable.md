...
C’est pourquoi [ce site est hyper rapide](/about/).
...
Au fond, je m’enorgueillis d’obtenir des [résultats parfaits dans PageSpeed Insights](https://pagespeed.web.dev/analysis/https-nicolasfriedli-ch/ml07tf4185?form_factor=mobile).
...
J’ai effectué des [mandats dans des domaines très différents](/bio/).
