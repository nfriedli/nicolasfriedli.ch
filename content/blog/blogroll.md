...
description = "Sélection de liens vers des sites personnels que j’apprécie et consulte régulièrement. Il y a très longtemps, on appelait cela un «blogroll»."
date = 2025-09-28
lastMod = "2025-11-30"
+++

Je vous propose une sélection de liens vers des **sites personnels** que j’apprécie et consulte régulièrement.
Ce sont des blogs que je suis dans mon aggrégateur de flux RSS et Atom.
...
- [Cory Dransfeldt](https://www.coryd.dev/)
...
- [Myriam Eric Suzanne](https://www.miriamsuzanne.com/)
- [Hidde de Vries](https://hidde.blog/)
- [Luke Wroblewski](https://www.lukew.com/)

## Blogs protestants

- [Laure Devaux Allisson](https://www.lauredevaux.ch/)
...
Ma liste complètes de flux suivis au [format OPML](https://fr.wikipedia.org/wiki/Outline_Processor_Markup_Language) est disponible sur simple demande.
Vous pourrez ensuite l’intégrer facilement dans votre agrégateur habituel (Feedly, Inoreader, Feedbin, etc.).
Sur cette page, j’ai limité la sélection à des blogs qui sont toujours en activité.
