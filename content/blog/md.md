...
- pourrir la vie des internautes avec des notes de bas de pages[^1]
- faire vivre le web avec des liens
- ajouter des images

[^1]: Je considère que les notes de bas de pages sont souvent contre-productives sur le web, notamment parce que la notion de «page» n’a rien à voir avec le monde de l’imprimé dont elles sont issues.
Les liens, les encadrés ou de bons systèmes de références permettent de faire mieux dans la grande majorité des cas.
...
Par exemple, `##` permet d’insérer un intertitre sans quitter le clavier.
...
Sur GitHub, vous trouverez la [source de cette page](https://github.com/nfriedli/theologique.ch/blob/main/content/blog/md.md).
...
[Separate Writing and Formatting](https://ia.net/topics/separate-writing-and-formatting)

[Le futur de l’édition scientifique est au format texte](https://www.arthurperret.fr/blog/2025-06-13-le-futur-de-l-edition-scientifique-est-au-format-texte.html)

[CommonMark](https://commonmark.org/)

[always bet on text](https://graydon2.dreamwidth.org/193447.html)

[La mécanique du texte](https://tcrouzet.com/2015/06/30/tu-ecris-alors-questionne-tes-outils/)

[La mécanique du texte. Ou l’influence des outils sur l’écrit.](https://www.elaee.com/2015/06/30/23712-la-mecanique-du-texte-ou-linfluence-des-outils-sur-lecrit)


reStructuredText, LaTeX, AscuuDoc & co.
