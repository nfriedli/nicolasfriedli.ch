...
C'est tout!
Pas besoin de droits d'administration, pas de dépendances, pas de configuration.
...
Ou s'en réjouir, parce que l'on pense encore et toujours qu'un site est (souvent) constitué d'un certain nombre de pages organisée dans une arborescence.
...
Pas de javascript, pas forcément de statistiques (autres que celles du serveur), un chargement efficace des polices d'écriture.
...
L'utilisation de plusieurs taxonomies, avec des pondérations et des seuil de proximité, etc. permet d'affiner les choix.
